            ...
            <form onSubmit={handleLogin} className="space-y-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="border border-slate-200 hover:border-blue-600/50 focus-within:border-blue-600/80 transition-all duration-300 h-14 bg-white w-full rounded-2xl"
                />
              </div>
