    ...
    >
      {slides.map((slide) => (
        <SwiperSlide key={slide}>
          <section className="relative overflow-hidden pt-12 pb-24 md:pt-24 md:pb-32 bg-gradient-to-br from-blue-50 via-slate-50 to-slate-50">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-8">
                  ...
                  <p className="text-xl text-slate-500 leading-relaxed max-w-xl">
                    ...
                    taught by industry professionals. Start your learning
                    journey today.
                  </p>
